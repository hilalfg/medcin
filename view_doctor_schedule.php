...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="row">
			<table class="table table-striped table-bordered">
				<thead>
					<tr>
						<th class="text-center">رۆژ</th>
						<th class="text-center">خشتە</th>
					</tr>
				</thead>
				<tbody>
	...
	<hr>
		<div class="row">
			<button class="btn btn-secondary btn-sm col-md-4 offset-md-4 " type="button" data-dismiss="modal" id="">داخستن</button>
		</div>
	</div>
</div>
<script>
